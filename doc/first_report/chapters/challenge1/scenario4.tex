...
\begin{figure}[!ht]
    ...
    \begin{minipage}{\linewidth}
        \input{images/resultado-desafio1-cenario4-a.tex}
    \end{minipage}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \begin{minipage}{\linewidth}
        \input{images/resultado-desafio1-cenario4-b.tex}
    \end{minipage}
\end{figure}
...
\ref{fig:resultado-desafio1-cenario4-c}. Observa-se que o resultado obtido está
...
\begin{figure}[!ht]
    ...
    \vspace{-10pt}
    \hspace{-30pt}
    \label{fig:resultado-desafio1-cenario4-c}
    \begin{minipage}{\linewidth}
        \input{images/resultado-desafio1-cenario4-c.tex}
    \end{minipage}
\end{figure}